...
var VuexSys = /** @class */ (function () {
     ...
     * @param key
     */
    VuexSys.prototype.fRefreshCmd = function (key) {
     ...
     * @param key
     */
    VuexSys.prototype.fRefreshOne = function (key) {
     ...
     * @param key
     */
    VuexSys.prototype.fRefreshList = function (key) {
     ...
     * @param key
     */
    VuexSys.prototype.fRefreshIx = function (key) {
     ...
     * @param key
     */
    VuexSys.prototype.fRefreshTree = function (key) {
    ...
    VuexSys.prototype.registerModuleCmd = function (state) {
        this.store.registerModule('cmd', {
            ...
            mutations: {
                ...
                refresh_cmd: function (state, key) {
                    if (state[key]) {
                        var tempVal = state[key];
                        state[key] = {};
                        state[key] = tempVal;
                    }
                }
     ...
     * @param state
     */
    VuexSys.prototype.registerModuleIx = function (state) {
        this.store.registerModule('ix', {
            state: state,
            mutations: {
                refresh_ix: function (state, key) {
                    if (state[key]) {
                        var tempVal = state[key];
                        state[key] = {};
                        state[key] = tempVal;
    ...
    VuexSys.prototype.registerModuleOne = function (state) {
        this.store.registerModule('one', {
            ...
            mutations: {
                ...
                refresh_one: function (state, key) {
                    if (state[key]) {
                        var tempVal = state[key];
                        state[key] = {};
                        state[key] = tempVal;
    ...
    VuexSys.prototype.registerModuleList = function (state) {
        this.store.registerModule('list', {
            ...
            mutations: {
                ...
                refresh_list: function (state, key) {
                    if (state[key]) {
                        var tempVal = state[key];
                        state[key] = [];
                        state[key] = tempVal;
    ...
    VuexSys.prototype.registerModuleTree = function (state) {
        this.store.registerModule('tree', {
            ...
            mutations: {
                ...
                refresh_tree: function (state, key) {
                    if (state[key]) {
                        var tempVal = state[key];
                        state[key] = {};
                        state[key] = tempVal;
     ...
     */
    VuexSys.prototype.getIxStore = function () {
