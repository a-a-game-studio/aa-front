...
class Ctrl extends aaFront.BaseCtrl {
    constructor(store) {
        super(store, conf_login_1.pageConf);
    }
    fInit() {
        this.querySys.fInit();
        this.querySys.fOne('one_user_info', 'user');
        this.querySys.fStatus('user_id', 'user_id');
        this.querySys.fSend(conf_login_1.pageConf.api.index, null);
    }
    ;
    //=========================================
    /** Авторизоваться */
    fLogin(data) {
        ...
        this.querySys.fSend(conf_login_1.pageConf.api.login, data);
    }
    ;
    //=========================================
    /** Выход */
    fLogout() {
        ...
        this.querySys.fSend(conf_login_1.pageConf.api.logout, null);
